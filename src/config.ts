    ...
    schema: {
       SNAPSHOT_DOWNLOAD_PATH: {
        ...
        TrustedAppProtocolVersionSigners: {
            type: 'array',
            default: ["02a5e2811a9bfa4eec274e806debd622c53702bce39a809918563a4cf34189ff85"]
        },
        IceServerStrings: {
            type: 'array',
            default: [
...
export const standaloneProperties: StandaloneProperties = {
    ...
    TrustedAppProtocolVersionSigners: electronStore.get('TrustedAppProtocolVersionSigners') as Array<string>,
