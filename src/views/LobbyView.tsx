...
import { withNodeStatus, useNodeStatusQuery, usePreloadProgressSubscriptionSubscription } from '../generated/graphql';
...
const LobbyView = ({accountStore, routerStore}: IStoreContainer) => {
    ...
    if (undefined !== nodeStatusQueryResult && undefined !== nodeStatusQueryResult.nodeStatus && null !== nodeStatusQueryResult?.nodeStatus) {
