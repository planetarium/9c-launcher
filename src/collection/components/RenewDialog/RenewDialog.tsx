        ...
        >
            <div className="RenewDialogContainer">
                <div className="RenewDialogInfomation">
                    If you modify the setting,<br/>
                    the reward schedule and amount automatically renewed.
                </div>
                <div className="RenewDialogButtonContainer">
                    <CollectionButton width={200} height={50} onClick={onCancel}>Cancel</CollectionButton>
                    <CollectionButton width={200} height={50} primary={true} onClick={onSubmit}>Ok</CollectionButton>
                </div>
            </div>
        </Dialog>
